    ...
    static {
        try {
            ...
            if (socket != null) {
                ...
                Log.d(TAG, "Setting allowed TLS protocols: " + TextUtils.join(", ", protocols));
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    Log.d(TAG, "Enabling (only) those TLS ciphers: " + TextUtils.join(", ", enabledCiphers));
                    SSLSocketFactoryCompat.cipherSuites = enabledCiphers.toArray(new String[enabledCiphers.size()]);
                }
            }
        } catch (IOException e) {
            Log.d(TAG, "Couldn't determine default TLS settings");
        }
    }
